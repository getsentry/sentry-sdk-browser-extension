...
function Loaded(sdkInfo: SdkInfo | undefined, options: BrowserOptions | undefined, latestVersion: string | undefined) {
	if (sdkInfo && options) {
...
function WithSdk(sdkInfo: SdkInfo, options: BrowserOptions, latestVersion: string | undefined) {
